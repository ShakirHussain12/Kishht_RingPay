...
//		Aclick(RingLoginPage.btnOkGotIt, "Button Ok, Got It!");
		...
		extent.extentLoggerPass("TC_Ring_Core_47", "TC_Ring_Core_47 To Verify if user only checked in whatsapp notification check box and Continue with \n"
				+ "read & accept");
		extent.extentLoggerPass("TC_Ring_Core_49", "TC_Ring_Core_49 To Verify when user clicks on read and accept with unchecked CKYC consent");
		...
		extent.extentLoggerPass("TC_Ring_Core_44", "TC_Ring_Core_44 To Verify after successful login, user should navigate to permission page");
